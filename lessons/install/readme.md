...
I installed Python 3. Support for Python 2 will soon be discontinued, so it is a good idea to get used to the changes now. Additionally, I don't want any errors when doing the HackerRank prework. 
